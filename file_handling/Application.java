...
public class Application {
	...
	public static void main(String[] args) {
		...
		String filename;
		char ch;
		File directory = new File("C:\\Users\\wi\\Desktop\\Java_Project\\");
		...
		System.out.println("*****************************************");
		System.out.println("******* Developed by ANAL MANDAL ********");
		System.out.println("*****************************************");
		...
		filename = input.next();
		try {
		File file = new File("C:\\Users\\wi\\Desktop\\Java_Project\\" + filename + ".txt");
...
//		}
		...
		filename = input.next();
		File directory_delete = new File("C:\\Users\\wi\\Desktop\\Java_Project\\");
		...
		File file = new File(
		"C:\\Users\\wi\\Desktop\\Java_Project\\" + delete_filename);
		if (file.delete()) {
		...
		filename = input.next();
		File directory_search = new File("C:\\Users\\wi\\Desktop\\Java_Project\\");
		...
		File folder = new File("C:\\Users\\wi\\Desktop\\Java_Project\\");
